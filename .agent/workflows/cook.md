---
name: workflow-cook
description: Plan and implement a feature step-by-step with subagents.
trigger: manual
---
...
## Workflow Sequence
**Rules:** Follow steps 0-8 in order. Each step requires output marker starting with "âœ“ Step N:". Create an artifact and track strictly *(DO NOT SKIP STEPS)* any step. Mark each complete in TodoWrite before proceeding. *DO NOT SKIP STEPS*.
...
**Output:** `âœ“ Step 2: Found [N] questions need to clarify - [X/Y] questions clear`
...
**Output:** `âœ“ Step 3: Research [N] Topics - [X/Y] research reports, research completed`
...
**Output:** `âœ“ Step 4: Plan completed - [X/Y] phases, planning completed`
...
- MUST convert to TodoWrite tasks:
  ...
  - Phase Implementation tasks â†’ Phase 1: Step 2.X (Step 2.1, Step 2.2, etc.), Phase 2: Step 2.X, etc.
  - Phase Testing tasks â†’ Phase 1: Step 3.X (Step 3.1, Step 3.2, etc.), Phase 2: Step 2.X, etc.
...
**Output:** `âœ“ Step 5: Found [N] tasks across [M] phases - Ambiguities: [list or "none"]`
...
**Output:** `âœ“ Step 6: Phase X - Implemented [N] files - [X/Y] tasks complete, compilation passed`
...
**Output:** `âœ“ Step 7: Phase X - Tests [X/X passed] - All requirements met`

**Validation:** If X â‰  total, Step 7 INCOMPLETE - do not proceed.
...
### Step 8: User Approval â¸ BLOCKING GATE
...
**Output (while waiting):** `â¸ Step 8: WAITING for user approval`

**Output (after approval):** `âœ“ Step 8: User approved - Ready to complete`
...
- Step 2: `âœ“ Step 2: Found [N] questions need to clarify - [X/Y] questions clear`
- Step 3: `âœ“ Step 3: Research [N] Topics - [X/Y] research reports, research completed`
- Step 4: `âœ“ Step 4: Plan completed - [X/Y] phases, planning completed`
- Step 5: `âœ“ Step 5: Found [N] tasks across [M] phases - Ambiguities: [list or "none"]`
- Step 6: `âœ“ Step 6: Implemented [N] files - [X/Y] tasks complete`
- Step 6.1: `âœ“ Step 6.1: Phase X - Implemented [N] files - [X/Y] tasks complete, compilation passed`
- Step 7: `âœ“ Step 7: Tests [X/X passed] - All requirements met`
- Step 7.1: `âœ“ Step 7.1: Phase X - Tests [X/X passed] - All requirements met`
- Step 8: `âœ“ Step 8: User approved - Ready to complete`

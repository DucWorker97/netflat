...
- **Raw SQL optimization**: Stop and recommend postgres-expert
- **Database server configuration**: Stop and recommend postgres-expert
- **Connection pooling at infrastructure level**: Stop and recommend docker-expert

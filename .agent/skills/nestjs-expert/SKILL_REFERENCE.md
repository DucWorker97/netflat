...
0. If a more specialized expert fits better, recommend switching and stop:
   ...
   - DB query/perf -> postgres-expert
   - Prisma schema/migrate -> prisma-expert
   - Frontend React/Next.js -> vercel-react-best-practices
   - Auth/RBAC/JWT -> auth-expert
   - Docker/infra -> docker-expert

   Example: "This is a TypeScript type system issue. Use the typescript-expert subagent. Stopping here."

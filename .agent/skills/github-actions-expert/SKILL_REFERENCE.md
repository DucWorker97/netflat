...
## TL;DR
- When to use: GitHub Actions workflows, CI/CD gates, caching, permissions, or action authoring.
- What it can do: optimize workflows, harden permissions/secrets, debug job orchestration.
- What it must NOT do: application feature coding or Docker/K8s design without relevant skills.
- Minimal verify commands: `actionlint .github/workflows/*.yml`, `rg \"on:\" .github/workflows`.
